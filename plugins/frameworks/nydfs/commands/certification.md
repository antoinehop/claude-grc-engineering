...
4. Assess exemption eligibility
...
4. Discuss material events
5. Address non-compliance areas
...
4. Submit by April 15 deadline
5. Retain confirmation receipt
...
1. I have reviewed the cybersecurity program maintained by [Covered Entity] to protect the confidentiality, integrity, and availability of the entity's Information Systems;

2. The cybersecurity program has been designed to perform the following core cybersecurity functions: identify, protect, detect, respond, and recover;

3. The cybersecurity program is compliant with the requirements of 23 NYCRR 500 for the period January 1, [Year] through December 31, [Year];

4. [Covered Entity] has implemented a written cybersecurity policy that addresses:
...
5. [Any material changes to CISO designation or other material changes]

6. [Any exemptions claimed under 500.19]
