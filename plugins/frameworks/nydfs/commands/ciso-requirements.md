...
- Notify NYDFS within 72 hours (500.17)
...
- **Option 2**: Report to CEO/COO
  - Pros: Enterprise view, independence from IT
  - Cons: May lack technical context

- **Option 3**: Report to CFO/Chief Risk Officer
  - Pros: Risk management alignment
  - Cons: Resource competition

- **Option 4**: Report directly to Board
  - Pros: Maximum independence
  - Cons: Administrative burden on Board

**Best Practice**: Dual reporting (operationally to CXO, functionally to Board)

## Compensation and Budget Authority
...
```bash
# Evaluate employee CISO requirements
/nydfs:ciso-requirements employee qualifications

# Third-party CISO model assessment
/nydfs:ciso-requirements third-party compensation

# CISO reporting structure guidance
/nydfs:ciso-requirements employee reporting
```

## Resources

- **23 NYCRR 500.04**: CISO regulation text
- **NYDFS Industry Letters**: CISO expectations
- **FS-ISAC**: Financial Services Information Sharing and Analysis Center
- **NIST CSF**: Framework for CISO program structure
- **CISO Job Descriptions**: Industry samples
- **Compensation Surveys**: Robert Half, Mondo, Dice
